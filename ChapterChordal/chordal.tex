...
What do \textbf{Chords} look like? The following two graphs are examples of chordal graphs, one with # vertices, and anothe with # vertices. The chordal lines are visible in green.
\includegraphics[width=0.5\textwidth]{./ChapterChordal/chordalGraph.pdf}
\includegraphics[width=0.5\textwidth]{./ChapterChordal/chodralGraph2.pdf}
